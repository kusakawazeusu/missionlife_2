			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-body">
						<h2 class="text-center">發佈新講座</h2>
            	 <form class="form-horizontal" role="form" method="POST" action="{{ url('/newlecture') }}"> <!-- 這裡還沒加 -->
                                    {{csrf_field()}}
            	            ...
            	            <div class="form-group">
             	               <label for="name" class="col-md-2 col-md-offset-2 control-label">講座標題</label>
             	               <div class="col-md-6">
                          ...
                          <div class="form-group">
                             <label for="speaker" class="col-md-2 col-md-offset-2 control-label">演講人</label>
                             <div class="col-md-6">
                                 <input id="speaker" class="form-control" name="speaker" value="{{old('speaker')}}">
            	            ...
            	            <div class="form-group">
                              ...
                              <div class="form-group">
                                    <label for="execute_start_at" class="col-md-2 col-md-offset-2 control-label">講座開始日期</label>
                                    <div class="col-md-6">
                              ...
                              <div class="form-group">
                                    <label for="execute_end_at" class="col-md-2 col-md-offset-2 control-label">講座結束日期</label>
                                    <div class="col-md-6">
                              ...
                              <div class="form-group">
                                    <label for="place" class="col-md-2 col-md-offset-2 control-label">講座地點</label>
                                    <div class="col-md-6">
            	            ...
            	            <div class="form-group">
             	               	<label for="description" class="col-md-2 col-md-offset-2 control-label">講座描述</label>
             	               	<div class="col-md-6">
                          ...
                          <div class="form-group">
                              <label for="participate_award" class="col-md-2 col-md-offset-2 control-label">講座參加獎勵</label>
                              <div class="col-md-5">
            	            ...
            	            <div class="form-group">
             	               	<label for="max_people" class="col-md-2 col-md-offset-2 control-label">講座人數上限</label>
             	               	<div class="col-md-3">
